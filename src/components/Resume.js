      ...
      <div className="modal-container" id='resume-modal'>
        <div onClick={() => this.props.toggleResume()} className="blackground"/>
          <div className="content" id="style-1">
            ...
            <p><span><strong>Operating Systems:</strong> ​​Linux, Windows, MacOS</span>
            ...
            <span><strong>Office Tools:</strong> ​​Microsoft Office Suite, Libre Office Suite</span></p>

            <h2 id="workexperience">Work Experience</h2>

            <p><strong>Veos Apparel - Front End Developer (July 2018 - current)</strong></p>
            <p>Responsible for the creation and deployment of the Veos Apparel website.
            Built with React and deployed using Netlify.
            Landing site was created as a placeholder during kickstarter campaign.
            Main site created to display all content and add make online ordering possible.</p>
            <p><strong>Finality Labs - Front End Developer (April 2018 - current)
            </strong></p> 
            <p>Built the main site for the company from scratch using React. (​https://finalitylabs.io​)
            ...
            scalability.
            Implement, test, and deploy changes and updates to all company sites.</p>
            <p><strong>W Hotel San Francisco - Security (2007 - 2009, 2012 - 2018)</strong></p>

            <p>Provide safety and security to employees, guests, and clientele in the hotel, bar, and event
            spaces.
            ...
            <p><strong>Brew &amp; Brauts (2017)</strong></p>
            <p>Restaurant was looking for a way to optimize how they advertised their drink menu,
            ...
            To keep the same theme, the menu was designed to resemble a chalkboard</p>
            <p><strong>Gluten Free Bikes (2017)</strong></p>
            <p>Created the face of the company, which upheld its playful spirit without sacrificing
            professionalism.
            Full logo creation and animation as an added feature.
            Full responsive web app creation and deployment.</p>
            <p><strong>Vatchr Design (2017)</strong></p>
            <p>Multi-faceted process for creating a brand identity.
            ...
            <p><strong>Matthew Cesca Multimedia (2016)</strong></p>
            <p>Collaborated with the owner and founder to decipher and visually capture the essence of
            ...
            <p><strong>Sessions College for Professional Design</strong></p>
            <p><strong>Degree:</strong> Associates in Web Design (2017)</p>
            <p><strong>Focus:</strong> ​​ Web Design best practices including WCAG compliance, design theory, modern frameworks,
